...
class FormatCorrectPriceTestCase(unittest.TestCase):
    ...
    def test_format_price_formats_single_digit_integer(self):
        test_input = '5.000000'
        expected_output = '5'
        output = format_price.format_price(test_input)
        self.assertEqual(output, expected_output)

    def test_format_price_formats_thousands_value_integer(self):
        test_input = '3245.000000'
        expected_output = '3 245'
        output = format_price.format_price(test_input)
        self.assertEqual(output, expected_output)

    def test_format_price_formats_milions_value_integer(self):
        test_input = '3003245.000000'
        expected_output = '3 003 245'
        output = format_price.format_price(test_input)
        self.assertEqual(output, expected_output)

    def test_format_price_formats_zero(self):
        test_input = '0.000000'
        expected_output = '0'
        output = format_price.format_price(test_input)
        self.assertEqual(output, expected_output)

    def test_format_price_formats_one_digit_float(self):
        test_input = '0.000001'
        expected_output = '0,000001'
        output = format_price.format_price(test_input)
        self.assertEqual(output, expected_output)

    def test_format_price_formats_float_with_leading_and_trailing_zeros(self):
        test_input = '0.003000'
        expected_output = '0,003'
        output = format_price.format_price(test_input)
        self.assertEqual(output, expected_output)

    def test_format_price_formats_multiple_digit_float(self):
        test_input = '0.123000'
